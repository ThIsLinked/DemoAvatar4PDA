...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        scrollTooltip.setOnClickListener {
            val scrollTooltipToast = Toast.makeText(this, getString(R.string.scroll_tooltip_toast), Toast.LENGTH_SHORT)
            scrollTooltipToast.setGravity(Gravity.CENTER_HORIZONTAL, 0, 0)
            scrollTooltipToast.show()
        }

        /* Open link a source image when click */
        val exampleOriginalSource: MaterialButton = findViewById(R.id.example_original_source) // Set object ID
        // Action
        exampleOriginalSource.setOnClickListener {
            startActivity(Intent(Intent.ACTION_VIEW, Uri.parse("https://mr-dark-1amao.tumblr.com/post/689605799594639360/how-start-a-great-day-with-a-great")))
        }
        ...
        author.setOnClickListener {
            startActivity(Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/ThIsLinked/DemoAvatar4PDA")))
        }
